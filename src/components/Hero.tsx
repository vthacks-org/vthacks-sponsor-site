...
export default function Hero() {
    return (
        <div className="h-screen w-full flex items-center justify-center bg-[#050404] relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-zinc-900/20 via-transparent to-zinc-900/20 pointer-events-none z-10" />

            <div className="w-full h-full flex flex-col md:flex-row relative">
                <div className="w-full md:w-1/2 h-full flex items-end justify-start px-8 md:px-24 pb-16 md:pb-24 z-20">
